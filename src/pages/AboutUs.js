const AboutPage = () => {
  return (
    ...
    <p>But that's not all - we also have a secret menu! Ask your server about our "off the hook" dishes that will take your taste buds on a wild ride.</p>
    <p>At The Codfather's Oceanic Eats, we care about the environment. We source our seafood from local fishermen who use sustainable and ethical fishing practices. We believe that it's important to protect our oceans and support local businesses at the same time.</p>
    <p>So come on down to The Codfather's Oceanic Eats and experience seafood like you've never had before. We promise it will be a whale of a time!</p>
    </div>
    );
};
